...
class RDTheme_Address_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
            ...
            __( 'FinancePro: Address', 'financepro' ), // Name
            array( 'description' => __( 'FinancePro: Address Widget', 'financepro' ) ) // Args
            );
	}
	...
	public function form( $instance ){
		$defaults = array(
			'title'   => __( 'Corporate Office' , 'financepro' ),
			'address' => '',
			'phone'   => '',
			'email'   => '',
			'fax'     => ''  
		...
		$fields = array(
			...
			'address'   => array(
				'label' => esc_html__( 'Address', 'financepro' ),
				'type'  => 'text',
				),      
			'phone'     => array(
				'label' => esc_html__( 'Phone Number', 'financepro' ),
				'type'  => 'text',
				),      
			'email'     => array(
				'label' => esc_html__( 'Email', 'financepro' ),
				'type'  => 'text',
				),      
			'fax'       => array(
				'label' => esc_html__( 'Fax', 'financepro' ),
				'type'  => 'text',
				),
			);
