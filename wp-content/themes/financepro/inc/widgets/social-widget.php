...
class RDTheme_Social_Widget extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			...
			'description' => esc_html__( 'FinancePro: Social Widget' , 'financepro' ),
			'customize_selective_refresh' => true,
		);
		parent::__construct( 'rt-about-social', __( 'FinancePro: Social' , 'financepro' ), $widget_ops );
	...
	public function form( $instance ){
		$defaults = array(
			'title'       => esc_html__( 'About Company' , 'financepro' ),
			'image_uri'   => '',
			'image_url'   => '',
			'description' => '',
			'facebook'    => '',
		...
		$fields = array(
			'title'        => array(
				'label'    => esc_html__( 'Title', 'financepro' ),
				'type'     => 'text',
				),
			'image_uri'    => array(
				'label'    => esc_html__( 'Image URL', 'financepro' ),
				'type'     => 'text',
				),
			'image_url'    => array(
				'label'    => esc_html__( 'Image File Link', 'financepro' ),
				'type'     => 'text',
				),
			'description'  => array(
				'label'    => esc_html__( 'Description', 'financepro' ),
				'type'     => 'textarea',
				),
			'facebook'     => array(
				'label'    => esc_html__( 'Facebook URL', 'financepro' ),
				'type'     => 'url',
				),
			'twitter'      => array(
				'label'    => esc_html__( 'Twitter URL', 'financepro' ),
				'type'     => 'url',
				),
			'gplus'        => array(
				'label'    => esc_html__( 'Google Plus URL', 'financepro' ),
				'type'     => 'url',
				),
			'linkedin'     => array(
				'label'    => esc_html__( 'Button URL', 'financepro' ),
				'type'     => 'url',
				),
			'pinterest'    => array(
				'label'    => esc_html__( 'Pinterest URL', 'financepro' ),
				'type'     => 'url',
				),
			'rss'          => array(
				'label'    => esc_html__( 'Rss Feed URL', 'financepro' ),
				'type'     => 'url',
				),
			'instagram'    => array(
				'label'    => esc_html__( 'Instagram URL', 'financepro' ),
				'type'     => 'url',
				),
			);
